...
class CreatePasswordLocal extends StatefulWidget {
  String? name;
  String? dob;
  String? mbasiNumber;
  String? email;
  CreatePasswordLocal({
    ...
    required this.name,
    required this.dob,
    required this.mbasiNumber,
    required this.email,
  });

  @override
  State<CreatePasswordLocal> createState() => _CreatePasswordLocalState();
}

class _CreatePasswordLocalState extends State<CreatePasswordLocal> {
